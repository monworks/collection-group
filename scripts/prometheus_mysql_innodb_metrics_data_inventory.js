...
function prometheus_mysql_innodb_metrics_data_inventory(data) {
	var count = 0;
	...
	if (data.snmpData != undefined || data.snmpData != null) {
		...
		merge_result = merge_by_key("time", result);
		finalResult = [];
		var readobj = {};
		readobj["name"] = "innodb-read-total";
		readobj["componentId"] = "innodb-read-total";
		finalResult.push(readobj);


		var writeobj = {};
		writeobj["name"] = "innodb-write-total";
		writeobj["componentId"] = "innodb-write-total";
		finalResult.push(writeobj);


		var fsyncobj = {};
		fsyncobj["name"] = "innodb-fsync-total";
		fsyncobj["componentId"] = "innodb-fsync-total";
		finalResult.push(fsyncobj);


		var deadlockobj = {};
		deadlockobj["name"] = "innodb-deadlock-total";
		deadlockobj["componentId"] = "innodb-deadlock-total";
		finalResult.push(deadlockobj);
